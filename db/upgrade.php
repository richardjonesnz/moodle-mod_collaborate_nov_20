...
function xmldb_collaborate_upgrade($oldversion) {
    ...
    if ($oldversion < 2020110801) {
        ...
        upgrade_mod_savepoint(true, 2020110801, 'collaborate');
    }

    if ($oldversion < 2020110802) {

        // Define field grade to be added to collaborate_submissions at the end.
        $table = new xmldb_table('collaborate_submissions');
        $field = new xmldb_field('grade', XMLDB_TYPE_INTEGER, '10', null, null, null, null, null);
        ...
        upgrade_mod_savepoint(true, 2020110802, 'collaborate');
    }
