...
class restore_collaborate_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('SIMPLEMODVIEWBYID', '/mod/collaborate/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('SIMPLEMODINDEX', '/mod/collaborate/index.php?id=$1', 'course');
