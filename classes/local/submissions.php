...
class submissions {
     ...
     * @return string $page - the corresponding page.
     */
    ...
    /**
     * Return a calculated submission grade.
     *
     * @param array $attempts the the user has made.
     * @return the maximum grade the user has achieved in multiple submissions.
     */
